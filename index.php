...
<html>
    <head>
        ...
        <title>Welcome to Research Portal</title>
...
echo <<< EOT
    <body>
        ...
        <div id="menu">
            <table id="menu_cont">
                <tr>
                    <td style='width:70%'><img id="front_logo_small" src="images/front_logo_small.png"/></td>
                    <td style='width:30%'>
                ...
                <table id="s1_org">
                    ...
                    <tr>
                        <td>
                            <div id="overlay">
                                <a href="#">
                                    <img class="menu_sel" src="images/sample_finder.png" style="width:60%"/>
                                </a>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td colspan='2'><a href="pages/bob.php"><img class="menu_sel" src="images/analytics.png" style="width:50%"/></a></td>
                    </tr>
                </table>
            </div>
